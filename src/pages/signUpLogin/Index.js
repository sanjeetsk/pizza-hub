    ...
    <div className='wrapper'>{
      loginForm ? (
        <div className='signup-wrapper'>
          <h2 className='title'>Login on<span style={{ color: "var(--theme)"}} > The Pizza Hub.</span ></h2 >
          <form>
            <Input
              label="Email"
              type="email"
        ...
        <div className='signup-wrapper'>
          <h2 className='title'>Sign Up on<span style={{ color: "var(--theme)"}} >The Pizza Hub.</span ></h2 >
          <form>
            <Input
              label="Full Name"
              type="text"
